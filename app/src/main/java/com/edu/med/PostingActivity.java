...
public class PostingActivity extends AppCompatActivity {
    ...
    public void onViewClicked() {
        ...
        ProgressDialog progressDialog = new ProgressDialog(PostingActivity.this);
            ...
            databaseReference.setValue(map)
                    .addOnCompleteListener(task -> {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(relativeLayout,"✔ Success! Please wait for approval", Snackbar.LENGTH_LONG).show();
                            Toast.makeText(getApplicationContext(), "✔ Success! Please wait for approval", Toast.LENGTH_SHORT).show();
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            {
                image_link="";
                ImagePicker.Companion.with(PostingActivity.this)
