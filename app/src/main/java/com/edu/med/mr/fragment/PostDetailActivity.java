...
import com.edu.med.mr.CommentModel;
import com.edu.med.mr.ImageViewActivity;
import com.edu.med.mr.MainActivity;
import com.edu.med.mr.Notify;
import com.edu.med.mr.ReplayActivity;
...
public class PostDetailActivity extends AppCompatActivity {
    ...
    @BindView(R.id.post_icon2)
    CircleImageView postIcon2;
    ...
    String name, text, post_id, time, image, total_like, total_like2, total_comment, user_id;
    String total_replay;
...
*/
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        TextView name_text, text_text, like_text, like_text2, comment_text, like_text_rep;
        ImageView profile_icon, like_icon, like_icon2, comment_icon;
        ...
        public void setDetails(String name, String profile, String text, String key, int postiton, String id) {
            ...
            DatabaseReference like_count2 = FirebaseDatabase.getInstance().getReference("post").child(post_id).child("comment").child(key).child("like2");
            ...
            DatabaseReference like_database2 = FirebaseDatabase.getInstance().getReference("post").child(post_id).child("comment").child(key).child("like2").child(user.getUid());
...
//                like_icon.setImageDrawable(getResources().getDrawable(R.drawable.ic_thumb_up_black_24dp));
            ...
            like_icon2.setOnClickListener(v ->
...
//                like_icon.setImageDrawable(getResources().getDrawable(R.drawable.ic_thumb_up_black_24dp));
                            if (liked2) {
                                ...
                                like_database2.setValue(FirebaseAuth.getInstance().getCurrentUser().getDisplayName()).addOnCompleteListener(task ->
                                        Notify.notify(post_id, link, total_like, "like", "comment", name, id, key));
    ...
    private void getExtra() {
        ...
        viewPager.setVisibility(View.VISIBLE);
            List<String> elephantList = Arrays.asList(post_image_link.split(","));
            viewPager.setAdapter(new PagerAdapter(getApplicationContext(), ( elephantList)));
        ...
        Picasso.get().load(image).placeholder(R.drawable.ic_user).into(postIcon2);
