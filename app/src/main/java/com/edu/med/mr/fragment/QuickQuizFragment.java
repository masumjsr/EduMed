 ...
 */
public class QuickQuizFragment extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        {
            ...
            progressDialog.show();
            get_total();
            countDownTimer = new CountDownTimer(1000 * 60*10, 10) {
                @Override
    ...
    private void get_total() {
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("admin").child("contest").child("quick");
    ...
    private void getQuestion(int i) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("admin").child("contest").child("quick").child(i + "");
        databaseReference.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.exists()) {
                    ...
                    Builder dialogBuilder = new Builder(QuickQuizFragment.this);
                    ...
                    home.setOnClickListener(v -> {
                        ...
                        reference.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if (dataSnapshot.child("quick_point").exists()) {
                                    int i = dataSnapshot.child("quick_point").getValue(Integer.class);
                                    reference.child("quick_point").setValue(i + r);
                                } else {
                                    reference.child("quick_point").setValue(r);
                                }
                            }
