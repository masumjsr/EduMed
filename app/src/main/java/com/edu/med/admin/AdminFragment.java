    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                text=newText;
                setUpRecycler(   FirebaseDatabase.getInstance().getReference("user").orderByChild("email").startAt(newText)
);

                return false;
            }
        });
        setUpRecycler(   FirebaseDatabase.getInstance().getReference("user").orderByChild("role").equalTo("admin"));
 return view;   }
    ...
    public static class  ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            profile = itemView.findViewById(R.id.thumblin);
